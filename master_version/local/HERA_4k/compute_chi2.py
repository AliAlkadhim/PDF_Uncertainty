...
import numpy as np
import re
MVN_100 = np.load('/home/ali/Desktop/Pulled_Github_Repositories/NNPDF_Uncertainty/Compute_chi2/MVN_samples/MVN_100.npy')
...
for sample_ind in range(num_samples):
    ...
    with open(minuit_in_path, 'w') as second:
        ...
        second.write('  Bg   : [ ' + str(MVN_100[:,0][sample_ind]) + ', 0. ]\n')
        second.write('  Cg   : [ ' + str(MVN_100[:,1][sample_ind]) + ', 0. ]\n')
        second.write('  Agp   : [ ' + str(MVN_100[:,2][sample_ind]) + ', 0. ]\n')
        second.write('  Bgp   : [ ' + str(MVN_100[:,3][sample_ind]) + ', 0. ]\n')
        second.write('  Cgp   : [ ' + str(25.000) + ', 0. ]\n')
        #note that Cprig is a constant, not a parameter value!
        second.write('  Auv  :  DEPENDENT\n')
        second.write('  Buv   : [ ' + str(MVN_100[:,4][sample_ind]) + ', 0. ]\n')
        second.write('  Cuv   : [ ' + str(MVN_100[:,5][sample_ind]) + ', 0. ]\n')
        second.write('  Duv  : [    0     ]\n')
        second.write('  Euv   : [ ' + str(MVN_100[:,6][sample_ind]) + ', 0. ]\n')
        second.write('  Adv  :  DEPENDENT\n')
        second.write('  Bdv   : [ ' + str(MVN_100[:,7][sample_ind]) + ', 0. ]\n')
        second.write('  Cdv   : [ ' + str(MVN_100[:,8][sample_ind]) + ', 0. ]\n')
        second.write('  Aubar: [ 0.0, 0.0 ]\n')
        second.write('  Bubar: [ 0.0, 0.0  ]\n')
        second.write('  Cubar   : [ ' + str(MVN_100[:,9][sample_ind]) + ', 0. ]\n')
        second.write('  Dubar   : [ ' + str(MVN_100[:,10][sample_ind]) + ', 0. ]\n')
        second.write('  Adbar   : [ ' + str(MVN_100[:,11][sample_ind]) + ', 0. ]\n')
        second.write('  Bdbar   : [ ' + str(MVN_100[:,12][sample_ind]) + ', 0. ]\n')
        second.write('  Cdbar   : [ ' + str(MVN_100[:,13][sample_ind]) + ', 0. ]\n')
        second.write('\n')
...
chi2_array_100 = np.array(chi2_vals)
np.save('chi2_array_100.npy', chi2_array_100)
print(chi2_vals)
#print(s)
#print(matches)
# for match in matches:

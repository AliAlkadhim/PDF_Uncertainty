...
ndim=14
nwalkers = 14*(2**2) #has to be even, preferabbly a multiple of n_params
nparams=14
...
filename = 'SAMPLER_ONLYHERA_1k.h5'
...
sampler = emcee.EnsembleSampler(nwalkers, nparams, ll, backend = backend, threads=14)
...
#                              thin=nthin, 
#                              flat=True)
np.save('MCMC_samples_ONLYHERA_1k.npy', samples)

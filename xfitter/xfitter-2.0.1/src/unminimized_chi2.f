...
c      double precision parminuitsave(MNE)
       ...
       integer r_max
      parameter(r_max=100)
      Double precision MVN_cp(r_max, 14)
...
c       open(930, file='MVN_saved.txt') 

c       do r=1, r_max
c             do c=1, 2
c                   write(*, *) MVN_cp(r, c)
c c 931   format((100F10.4,2F10.4))
c             enddo
c       enddo    

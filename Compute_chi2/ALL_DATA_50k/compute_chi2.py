...
import numpy as np
import re
MVN_50k = np.load('/storage/5/home/aalkadhim/xfitter/CMSSW_10_2_27/src/RUNS/ALL_DATA_50k/MVN_50k.npy')
...
with open(minuit_in_path, 'w') as second:
    ...
    second.write('    '+ '2'+ '    ' + "'Bg'"+'    '+str(MVN_50k[:,0][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '3'+ '    ' + "'Cg'"+'    '+str(MVN_50k[:,1][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '7'+ '    ' + "'Aprig'"+'    '+str(MVN_50k[:,2][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '8'+ '    ' + "'Bprig'"+'    '+str(MVN_50k[:,3][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '9'+ '    ' + "'Cprig'"+'    '+str(25.000)+ '    '+'0.\n')
    #note that Cprig is a constant, not a parameter value!
    second.write('    '+ '12'+ '    ' + "'Buv'"+'    '+str(MVN_50k[:,4][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '13'+ '    ' + "'Cuv'"+'    '+str(MVN_50k[:,5][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '15'+ '    ' + "'Euv'"+'    '+str(MVN_50k[:,6][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '22'+ '    ' + "'Bdv'"+'    '+str(MVN_50k[:,7][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '23'+ '    ' + "'Cdv'"+'    '+str(MVN_50k[:,8][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '33'+ '    ' + "'CUbar'"+'    '+str(MVN_50k[:,9][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '34'+ '    ' + "'DUbar'"+'    '+str(MVN_50k[:,10][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '41'+ '    ' + "'ADbar'"+'    '+str(MVN_50k[:,11][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '42'+ '    ' + "'BDbar'"+'    '+str(MVN_50k[:,12][sample_ind])+ '    '+'0.\n')
    second.write('    '+ '43'+ '    ' + "'CDbar'"+'    '+str(MVN_50k[:,13][sample_ind])+ '    '+'0.\n')
    second.write('\n\n\n')
    #for complete fit, do
...
#ith open('MVN_50k_chi2s.txt', 'w') as MVN_chi2:
#    for item in chi2_vals_sample_ind:
#    MVN_chi2.write(chi2_vals_sample_ind)
chi2_array_50k = np.array(chi2_vals)
np.save('chi2_array_50k.npy', chi2_array_50k)
#print(chi2_vals)
#print(s)
#print(matches)
# for match in matches:

...
with open(minuit_in_path, 'w') as second:
    ...
    second.write('    '+ '2'+ '    ' + "'Bg'"+'    '+str(MVN_100k[:,0][2])+ '    '+'0.\n')
    second.write('    '+ '3'+ '    ' + "'Cg'"+'    '+str(MVN_100k[:,1][2])+ '    '+'0.\n')
    second.write('    '+ '7'+ '    ' + "'Aprig'"+'    '+str(MVN_100k[:,2][2])+ '    '+'0.\n')
    second.write('    '+ '8'+ '    ' + "'Bprig'"+'    '+str(MVN_100k[:,3][2])+ '    '+'0.\n')
    second.write('    '+ '9'+ '    ' + "'Cprig'"+'    '+str(25.000)+ '    '+'0.\n')
    #note that Cprig is a constant, not a parameter value!
    second.write('    '+ '12'+ '    ' + "'Buv'"+'    '+str(MVN_100k[:,4][2])+ '    '+'0.\n')
    second.write('    '+ '13'+ '    ' + "'Cuv'"+'    '+str(MVN_100k[:,5][2])+ '    '+'0.\n')
    second.write('    '+ '15'+ '    ' + "'Euv'"+'    '+str(MVN_100k[:,6][2])+ '    '+'0.\n')
    second.write('    '+ '22'+ '    ' + "'Bdv'"+'    '+str(MVN_100k[:,7][2])+ '    '+'0.\n')
    second.write('    '+ '23'+ '    ' + "'Cdv'"+'    '+str(MVN_100k[:,8][2])+ '    '+'0.\n')
    second.write('    '+ '33'+ '    ' + "'CUbar'"+'    '+str(MVN_100k[:,9][2])+ '    '+'0.\n')
    second.write('    '+ '34'+ '    ' + "'DUbar'"+'    '+str(MVN_100k[:,10][2])+ '    '+'0.\n')
    second.write('    '+ '41'+ '    ' + "'ADbar'"+'    '+str(MVN_100k[:,11][2])+ '    '+'0.\n')
    second.write('    '+ '42'+ '    ' + "'BDbar'"+'    '+str(MVN_100k[:,12][2])+ '    '+'0.\n')
    second.write('    '+ '43'+ '    ' + "'CDbar'"+'    '+str(MVN_100k[:,13][2])+ '    '+'0.\n')
    second.write('\n\n\n')
    #for complete fit, do
...
#    for item in chi2_vals_2:
#    MVN_chi2.write(chi2_vals_2)
